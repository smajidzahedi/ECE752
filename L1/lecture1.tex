...
\begin{document}
 ...
 \begin{frame}
  \begin{center}
   \includegraphics[width=0.3\textwidth]{/Users/smzahedi/Documents/UW Courses/FMAS/Public/Figures/L1/ece752}
  \end{center}
 \end{frame}
  \begin{frame}{Course Mechanics}
   \begin{itemize}[<+->]
    ...
    \item Course website
    \begin{itemize}[<.->]
     \item \href{https://ece.uwaterloo.ca/~smzahedi/crs/ece752}{\url{https://ece.uwaterloo.ca/~smzahedi/crs/ece752/}}
...
%     \qrcode[height=0.5in]{https://ece.uwaterloo.ca/\string~smzahedi/crs/ece752}
%    \end{textblock*}
%   }
  \end{frame}
 ...
 \section{Course Outline}
  ...
  \begin{frame}{Survey Project (Undergraduate Offering)}
   ...
   \setlength{\itemsep}{1em}
    ...
    \item Two milestones: proposal (10\%) and final written report (90\%)
   \end{itemize}
  \end{frame}
  ...
  \begin{frame}{Research Project (Graduate Offering)}
   ...
   \item Three milestones: proposal (10\%), final presentation (50\%), and final written report (40\%)
